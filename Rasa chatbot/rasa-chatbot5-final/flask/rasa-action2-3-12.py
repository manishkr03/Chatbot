...
class ActionDatabase(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        msg = "Yes, We have most popular packages according your [Diabetes] related query. {} it covers all {} test. Free home sample collection".format(ls_p_plane[0],conditions)
...
class ActionLink(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        #url_img=str(ls_p_image[0])
        #url_slug= str(ls_p_slug[0])
        #img="https://www.kayawell.com/Data/PlanImage/{}".format(url_img.lstrip())
        #slug="https://www.kayawell.com/Wellness/{}".format(url_slug.lstrip())
		#dispatcher.utter_message('<a href="'+slug+'"  > <img src="'+img+'" width="200" height="100"></a>')
...
class ActionButton(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        buttons = [{"title": "Book Now", "payload": "/ask_book"}, {"title": "View More", "payload": "/bye"}]
        dispatcher.utter_button_message("please click to proceed:", buttons)
